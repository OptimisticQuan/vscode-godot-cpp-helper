...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.create-implementation', require('./commands/CreateImplementation').default));
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.create-implementation-here', require('./commands/CreateImplementationHere').default));
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.copy-implementation', require('./commands/CopyImplementation').default));
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.create-header-guard', require('./commands/CreateHeaderGuard').default));
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.copy-getter-and-setter', require('./commands/CopyGetterAndSetter').default));
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.create-bind-method', require('./commands/CreateBindMethod').default));
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.copy-bind-method', require('./commands/CopyBindMethod').default));
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.copy-bind-method-code', require('./commands/CopyBindMethodCode').default));
	context.subscriptions.push(vscode.commands.registerCommand('godot-cpp-helper.copy-add-property', require('./commands/CopyAddProperty').default));
}
